...
function EditServiceProvider() {
  ...
  useEffect(() => {
    ...
    let getUserData = async () => {
      await axios
        .get(`http://localhost:5000/admin/service-providers/edit/${id}`,{
          headers: {
            token: token,
          }
        })
 ...
 const handlePhoto = (e) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formdata.country === "null") {
      ...
      await axios.put(`http://localhost:5000/admin/service-providers/update/`, fd, {
          headers: {
            token: token,
  ...
  return (
    <div id="content" className="mx-5">
      <div className="text-center my-5 ">
        <h2>Edit Service Provider Record</h2>
      </div>
